...
if(optMaquina === optJugador)
{
    console.log("Empate");
}
else
{
    if((optMaquina ==="Tijera") && (optJugador ==="Papel"))
    {
        console.log("Perdí");
    }

    if((optMaquina ==="Tijera") && (optJugador ==="Piedra"))
    {
        console.log("Gané");
    }


    if((optMaquina ==="Papel") &&(optJugador ==="Tijera"))
    {
        console.log("Gané");
    }

    if((optMaquina ==="Papel") &&(optJugador ==="Piedra"))
    {
        console.log("Perdí");
    }


    if((optMaquina ==="Piedra") &&(optJugador ==="Tijera"))
    {
        console.log("Perdí");
    }

    if((optMaquina ==="Piedra") &&(optJugador ==="Papel"))
    {
        console.log("Gané");
    }
